...
<section class="orders">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> commande totale : <span><?php echo $fetch_orders['total_products']; ?></span> </p>
         ...
         <form action="" method="post">
            ...
            <select name="update_payment">
               <option value="statut_de_paiement" selected disabled><?php echo $fetch_orders['payment_status']; ?></option>
